      ...
      <div className="flex">
        <div className="flex flex-col">
          <div className="ml-[300px] ">
            <h1 className="text-[#4F4F4F] mt-100px font-BalooBhai2 text-36 font-semibold leading-normal  text-5xl">
              Rewards
            </h1>
          </div>
        </div>
        <div className="ml-[1280px]  text-[#527845] text-4xl">
          <FaBell />
        </div>
        <button className=" text-white flex w-[150px] h-0 p-7 justify-center items-center gap-10 flex-shrink-0 rounded-8 border ml-[40px] border-[#92B786] bg-[#92B786] rounded-lg shadow-lg p-4 ">
          Login
        </button>
      </div>
